<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <div class="bg-dark" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
        ...
        <a href="#" class="list-group-item list-group-item-action bg-secondary" style="color: white">공연 및 버스킹 인원 모집</a>
        <a href="#" class="list-group-item list-group-item-action bg-secondary" style="color: white">Status</a>
      </div>
    </div>